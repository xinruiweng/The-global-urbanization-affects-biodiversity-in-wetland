...
res_overall_taxa <- rma.mv(yi, vi,
                      mods = ~ taxa_grouped + income_region + wetland_type_grouped + scale_grouped + koppen_climate, 
...
var_names <- c("taxa_grouped", "income_region", "wetland_type_grouped", "scale_grouped", "koppen_climate")
